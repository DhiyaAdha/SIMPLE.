...
<head>
    ...
    <link
        href="{{ url('https://fonts.googleapis.com/css2?family=Inter:wght@200;400;600;700;900&family=Poppins:wght@400;600;700&display=swap"
            rel="stylesheet') }}">
    ...
    <aside class="app-sidebar">
        <div class="app-sidebar__user">
            ...
            <div>
                ...
                <p class="app-sidebar__user-designation">{{ auth()->user()->roleuser()->first()->name ?? '' }}</p>
